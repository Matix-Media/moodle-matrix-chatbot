...
from bsbot.api.index.aliases import alias_text
from bsbot.api.index.store import Document, Store, content_sha256
from bsbot.api.pii.tokenizer import PiiTokenizer
from bsbot.api.rag.prompts import (
    CONTEXTUAL_CHUNK_TEMPLATE,
    DOCUMENT_SUMMARY_TEMPLATE,
    HYPE_TEMPLATE,
)
from bsbot.cron.extract import EXTRACT_VERSION, OcrCallable
from bsbot.cron.segments import FetcherLike, TaskcardsFetch, resolve_segments
from bsbot.cron.youtube import TranscriptApi
from bsbot.shared.chunk import (
...
class Indexer:
    def __init__(
        ...
        *,
        ...
        #: bsbot.api.index.aliases for why this exists: institutional naming no
    ...
    async def _index_one(self, document: Document, stats: IndexStats) -> None:
        ...
        `bsbot.cron.segments.resolve_segments` and specs/019-microservice-split.md).
        """
    ...
    async def index_segments(
        ...
        sent over the wire.
        """
        from bsbot.shared.chunk import Chunk
