...
from bsbot.api.index.store import Document
from bsbot.cron.extract import ExtractionError, OcrCallable, extract
from bsbot.cron.fetcher import FetchResult
from bsbot.cron.google_docs import GoogleDocsUnsupported, google_export_url
from bsbot.cron.hackmd import HackmdUnsupported, hackmd_markdown_url
from bsbot.cron.nextcloud import ShareUnsupported, share_download_url
...
from bsbot.cron.youtube import TranscriptApi, extract_video_id, fetch_transcript
...
async def _taskcards_segments(
    ...
    # see bsbot.cron.taskcards.fetch_board's docstring.
